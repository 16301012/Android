...
public class MainActivity extends AppCompatActivity implements
    ...
    private ArrayList<ShowItemModel> showListCopy;
    ...
    public MainActivity() {
        showListCopy = new ArrayList<ShowItemModel>();
    }
    ...
    private void initView() {
        ...
        myAvatarCIV = findViewById(R.id.my_avatar_civ);
        userName = findViewById(R.id.currentUserName_tv);
    ...
    private void initDrawerLayout() {
        ...
        TextView toFriend = v1.findViewById(R.id.tvMyFriend);
        myName = v1.findViewById(R.id.myName_tv);
        loginout = v1.findViewById(R.id.loginout);
        leftUserAvatarCIV = v1.findViewById(R.id.left_my_avatar_civ);
        try {
    ...
    class MyexpandableListAdapter extends BaseExpandableListAdapter {
        ...
        public View getGroupView(final int groupPosition, boolean isExpanded,
            ...
            if (convertView == null) {
                ...
                showHolder.showUsernameTv = convertView.findViewById(R.id.show_username_tv);
                showHolder.showUserAvatarCIv = convertView.findViewById(R.id.show_user_avatar_civ);
                showHolder.showTextTv = convertView.findViewById(R.id.show_text_content_tv);
                showHolder.showTimeTv = convertView.findViewById(R.id.show_time_tv);
                showHolder.expandedIv = convertView.findViewById(R.id.expanded_iv);
                showHolder.showImageRv = convertView.findViewById(R.id.show_recycler_view);
                convertView.setTag(showHolder);
            } else {
                showHolder = (ShowHolder) convertView.getTag();
            }

            showVideoView = convertView.findViewById(R.id.show_video_view);
            showVideoPlayBtn = convertView.findViewById(R.id.show_video_play_video_iv);
        ...
        public View getChildView(final int groupPosition, final int childPosition,
            ...
            if (convertView == null) {
                ...
                commentHolder.commentUsernameTv = convertView.findViewById(R.id.comment_username_tv);
                commentHolder.playVoiceCommentBtn = convertView.findViewById(R.id.play_comment_audio_btn);
                commentHolder.timeofvoice = convertView.findViewById(R.id.time_of_voice_tv);
                commentHolder.sendVoiceCommentBtn = convertView.findViewById(R.id.send_comment_audio_btn);
                commentHolder.commentTimeTv = convertView.findViewById(R.id.comment_time_tv);
    ...
    protected void onResume() {
        ...
        nameList.clear();
        //切换群
        mTView = findViewById(R.id.value_tv);
        mBtnDropDown = findViewById(R.id.dropdown_ib);
